...
const offboardingChecklistSchema = new mongoose_1.default.Schema({
    employeeId: {
        type: String,
        required: true,
        unique: true,
...
if (mongoose_1.default.models.OffboardingChecklist) {
    delete mongoose_1.default.models.OffboardingChecklist;
}
exports.default = mongoose_1.default.model('OffboardingChecklist', offboardingChecklistSchema);
//# sourceMappingURL=OffboardingChecklist.js.map