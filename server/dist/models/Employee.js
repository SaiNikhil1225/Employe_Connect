...
const employeeSchema = new mongoose_1.default.Schema({
    ...
    dottedLineManager: mongoose_1.default.Schema.Types.Mixed,
    leavePlan: {
        type: String,
    ...
    onboardingStatus: {
        ...
        assignedBuddy: mongoose_1.default.Schema.Types.Mixed,
        welcomeKitIssued: {
            type: Boolean,
            default: false
        },
...
function calculateMonthsBetween(startDate) {
    if (!startDate)
        return 0;
...
if (mongoose_1.default.models.Employee) {
    delete mongoose_1.default.models.Employee;
}
