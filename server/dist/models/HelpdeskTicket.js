...
const approvalLevelSchema = new mongoose_1.default.Schema({
    level: {
        type: String,
        enum: ['L1', 'L2', 'L3'],
        required: true
...
const resolutionSchema = new mongoose_1.default.Schema({
    resolvedBy: String,
    resolvedAt: String,
    notes: {
        type: String,
...
const historyLogSchema = new mongoose_1.default.Schema({
    action: {
        type: String,
        required: true
    },
...
// SLA Sub-Schema
const slaSchema = new mongoose_1.default.Schema({
    approvalSlaHours: {
        type: Number,
        default: 24
    },
...
helpdeskTicketSchema.methods.canBeCancelled = function () {
...
helpdeskTicketSchema.methods.checkSLAStatus = function () {
...
exports.default = mongoose_1.default.model('HelpdeskTicket', helpdeskTicketSchema);
//# sourceMappingURL=HelpdeskTicket.js.map