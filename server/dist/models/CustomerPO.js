...
const customerPOSchema = new mongoose_1.default.Schema({
    contractNo: {
        type: String,
...
const CustomerPO = mongoose_1.default.model('CustomerPO', customerPOSchema);
exports.default = CustomerPO;
//# sourceMappingURL=CustomerPO.js.map