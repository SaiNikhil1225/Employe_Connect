...
const ConfigMasterSchema = new mongoose_1.Schema({
    type: {
        type: String,
        required: true,
...
ConfigMasterSchema.statics.nameExists = async function (type, name, excludeId) {
    const query = {
        type,
...
exports.default = mongoose_1.default.model('ConfigMaster', ConfigMasterSchema);
//# sourceMappingURL=ConfigMaster.js.map