    ...
    try {
        ...
        const profile = {
            ...
            emergencyContact: typeof employeeObj.emergencyContact === 'string'
                ...
                : employeeObj.emergencyContact?.phone || '',
            // Primary details
...
// Update profile
router.put('/:employeeId', auth_1.authenticateToken, validation_1.employeeValidation.update, async (req, res) => {
    try {
        ...
        const employee = await Employee_1.default.findOneAndUpdate({
            $or: [
                { employeeId: req.params.employeeId },
                { id: req.params.employeeId }
            ]
...
router.patch('/:employeeId/:section', auth_1.authenticateToken, async (req, res) => {
    try {
