...
const employeeSchema = new mongoose_1.default.Schema({}, { strict: false });
...
async function fixEmployeeData() {
    try {
        ...
        await Employee.findOneAndUpdate({ employeeId: 'EMP001' }, {
            $set: {
        ...
        await Employee.findOneAndUpdate({ employeeId: 'RMG001' }, {
            $set: {
                name: 'Mohan Reddy',
        ...
        await Employee.findOneAndUpdate({ employeeId: 'HR001' }, {
            $set: {
                name: 'HR Admin',
        ...
        await Employee.findOneAndUpdate({ employeeId: 'MGR001' }, {
            $set: {
                name: 'Rajesh Kumar',
        ...
        await Employee.findOneAndUpdate({ employeeId: 'IT001' }, {
            $set: {
                name: 'Priya Sharma',
...
fixEmployeeData();
//# sourceMappingURL=fixEmployees.js.map