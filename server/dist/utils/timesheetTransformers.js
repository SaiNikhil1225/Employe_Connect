...
exports.weekRowsToDateEntries = weekRowsToDateEntries;
exports.dateEntriesToWeekRows = dateEntriesToWeekRows;
 ...
 */
function weekRowsToDateEntries(employeeId, employeeName, weekStart, rows) {
    const entries = [];
    rows.forEach(row => {
 ...
 */
function dateEntriesToWeekRows(weekStart, entries) {
 ...
 */
function determineOverallStatus(entries) {
    if (entries.length === 0) {
        return 'draft';
    }
...
//# sourceMappingURL=timesheetTransformers.js.map