...
if (mongoose.models.OnboardingChecklist) {
  delete mongoose.models.OnboardingChecklist;
}

export default mongoose.model('OnboardingChecklist', onboardingChecklistSchema);
