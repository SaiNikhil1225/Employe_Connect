...
export const commonValidations = {
  ...
  employeeId: body('employeeId')
    .trim()
    .matches(/^EMP[0-9]{3,4}$/)
    .withMessage('Employee ID must match format EMP000 or EMP0000'),
...
export const employeeValidation = {
  create: [
    ...
    body('employeeId')
      .trim()
      .matches(/^(EMP[0-9]{3,4}|ACU[ACI][0-9]{4})$/)
      .withMessage('Employee ID must match format EMP000/EMP0000 or ACUA/ACUC/ACUI followed by 4 digits'),
    body('department')
      .trim()
      .notEmpty()
