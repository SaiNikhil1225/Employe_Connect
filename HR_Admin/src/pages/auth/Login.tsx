    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="hidden md:flex md:w-[60%] bg-primary relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <svg className="absolute top-10 left-10 w-64 h-64" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#FFFFFF" d="M45.4,-77.7C58.8,-69.3,69.6,-56.9,77.8,-42.8C86,-28.7,91.6,-14.4,91.1,-0.2C90.6,14,83.9,28,75.4,40.8C66.9,53.6,56.6,65.2,43.8,72.4C31,79.6,15.5,82.4,0.5,81.5C-14.5,80.6,-29,76,-42.2,68.9C-55.4,61.8,-67.3,52.2,-75.8,39.4C-84.3,26.6,-89.4,10.6,-88.6,-5.1C-87.8,-20.8,-81.1,-36.2,-71.4,-48.8C-61.7,-61.4,-49,-71.2,-35.1,-79.3C-21.2,-87.4,-6,-93.8,7.6,-105.4C21.2,-117,32,-133.8,45.4,-77.7Z" transform="translate(100 100)" />
          </svg>
          <svg className="absolute bottom-10 right-10 w-96 h-96" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#FFFFFF" d="M39.5,-66.3C51.4,-58.5,61.5,-48.3,68.4,-36.2C75.3,-24.1,79,-10.1,78.8,4.1C78.6,18.3,74.5,32.6,66.8,44.3C59.1,56,47.8,65.1,35.3,70.4C22.8,75.7,9.1,77.2,-4.8,75.5C-18.7,73.8,-32.8,68.9,-45.1,61.4C-57.4,53.9,-67.9,43.8,-74.2,31.4C-80.5,19,-82.6,4.3,-80.1,-9.5C-77.6,-23.3,-70.5,-36.2,-60.3,-46.4C-50.1,-56.6,-36.8,-64.1,-23.4,-71.3C-10,-78.5,3.4,-85.4,16.8,-86.1C30.2,-86.8,27.6,-74.1,39.5,-66.3Z" transform="translate(100 100)" />
          </svg>
        </div>
          ...
          <div className="max-w-lg text-left space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-white/90 leading-relaxed max-w-md">
                Streamline your HR operations, manage employee data, and enhance workplace productivity with our comprehensive employee management platform.
              </p>
            </div>
          </div>
