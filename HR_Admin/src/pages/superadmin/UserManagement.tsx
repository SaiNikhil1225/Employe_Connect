                        ...
                        <div className="flex items-center gap-3">
                          <Avatar className="h-9 w-9">
                            <AvatarFallback 
                              ...
                              style={{
                                backgroundColor: getAvatarColor(user.employeeId || user.id).bg,
                                color: getAvatarColor(user.employeeId || user.id).text,
                              }}
                            >
              ...
              <div className="flex items-center gap-4">
                <Avatar className="h-16 w-16">
                  <AvatarFallback 
                    ...
                    style={{
                      backgroundColor: getAvatarColor(viewingUser.employeeId || viewingUser.id).bg,
                      color: getAvatarColor(viewingUser.employeeId || viewingUser.id).text,
                    }}
                  >
