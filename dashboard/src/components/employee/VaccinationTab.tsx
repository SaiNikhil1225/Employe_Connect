              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(date) => setFormData({ ...formData, dose1Date: date })}
                    placeholder="Select dose 1 date"
                  />
                </div>
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(date) => setFormData({ ...formData, dose2Date: date })}
                    placeholder="Select dose 2 date"
                  />
                </div>
                <div>
                  ...
                  <DatePicker
                    ...
                    onChange={(date) => setFormData({ ...formData, boosterDate: date })}
