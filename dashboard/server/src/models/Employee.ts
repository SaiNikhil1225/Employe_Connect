...
const employeeSchema = new mongoose.Schema({
  ...
  designationHistory: [{
    ...
    promotionType: {
      type: String,
      enum: ['promotion', 'lateral-move', 'internal-transfer', 'role-change']
    },
    notes: String
  }],
...
// Note: employeeId, email already have unique indexes from 'unique: true' in schema
// panNumber uses sparse unique index (defined in schema field) to allow multiple null values
